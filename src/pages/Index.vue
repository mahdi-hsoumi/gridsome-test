<template>
  <Layout>
    ...
    <g-image style="width: 500px;" alt="Example image" src="~/favicon.png" />
    <g-image style="width: 500px;" alt="Example image" src="~/image10.png" />
    <g-image style="width: 500px;" alt="Example image" src="~/kong.png" />
